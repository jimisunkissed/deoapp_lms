  ...
  return (
    <>
      <Box>
        ...
        <Box width={'100%'} alignItems={'center'} mx={20}>
          <Box bg='yellow.100' w='80%' p={4} m={4} color='black' fontSize={'sm'} display={'flex'} alignItems={'center'} gap={3} borderRadius={'10px'} >
            <FaExclamationCircle />
          ...
          <Box>
            ...
            <ChartDasboard />
            <Box>
              <Box w="80%" h="13rem" m={2} borderWidth={'1px'} borderColor={'gray.300'} alignContent={'center'} borderRadius={'10px'}>
